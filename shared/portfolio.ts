export const portfolioData = {
  ai_clone: {
    ...
    personality:
      "Friendly and professional, with deep knowledge of software development and AI technologies",
  },
  personal: {
  ...
  business: {
    ...
    dailyRate:
      "500-700€ HT/day, depending on project scope — always ask for project details before quoting a precise number",
    availability: "Available immediately",
    legalStatus:
      "Freelance work invoiced through TraveLearn SAS or TechNomadz SAS, no VAT applicable (HT)",
    travelearnBookingLink: "https://calendar.app.google/FMGnw5gvVgfZG3mi6", // Only offer this link for TraveLearn / training-related questions, never for freelance dev/AI client requests
  },
  intro: {
    shortBio:
      "Remote freelance developper with expertise in data and artificial intelligence",
    chatIntro:
      "Welcome! I'm Jeremy's AI assistant. Feel free to ask me about his work, skills, or anything else!", // Used as first chat message
...
Leverage my expertise to optimize your data and achieve your business goals. 📈`, // Used in About page
  ...
  projects: [
    // Use in Project page
    {
      ...
      description:
        "AI-powered blog automatically written by an agent I built and configured to find and summarize the latest relevant AI and tech news.",
    ...
    },
    {
      title: "Chess Verse",
      description:
        "Web app chess platform with experimental game modes, playable instantly with no account needed.",
    ...
    },
    {
      title: "Narcysse",
      description:
        "E-commerce site for a Parisian fashion brand designing matching couple's clothing.",
    ...
    },
    {
      title: "Mise à Jour",
      description:
        "Podcast breaking down freshly published scientific studies into clear language to make cutting-edge technology accessible to everyone.",
    ...
    },
    {
      title: "SudIncub",
      description:
        "Directory of startup support organizations in South of France area, with interactive filters.",
    ...
    },
    {
      title: "Lyriks",
      description:
        "Mobile app for replying to messages with iconic audio clips from movies/music.",
  ...
  experiences: [
    // Use in About page
    {
      ...
      description:
        "Qualiopi-certified training organization based in Nice, specialized in AI, no-code, and automation. Training delivered in French, in-person, in France and internationally, eligible for CPF and other continuing-education funding, with certification.",
    ...
    },
    {
      ...
      description:
        "AI and dev agency: building conversational AI agents, helping entrepreneurs build MVPs and web applications, and acting as an AI expert for startup incubators. Also advising on mobile application development and developing an admin dashboard interface (in progress).",
      link: null,
      skills: [
        "AI agents",
        "MVP development",
    ...
    },
    {
      ...
      description:
        "Marvyn is a venture capital analysis tool powered by artificial intelligence. It provides precise insights for startup evaluation. Our platform transforms how investors and venture capital firms access data, analyze investment opportunities, and make informed decisions.",
    ...
    },
    {
      ...
      description:
        "Designed and built data pipelines in Spark Python/SQL for audience analysis and online advertising. Scaled from 0 to 1 billion profiles managed daily in 2 years.",
    ...
    },
    {
      ...
      description:
        "Creative Data Team (TV & web profiling): Developed new Big Data features and managed production applications. Skill Center AI Team (Customer Experience Quality): Created a system incident tracking tool linked to customer feedback.",
    ...
    },
    {
      ...
      description:
        "R&D of advanced driver assistance systems for analyzing driving scenes in autonomous vehicles.",
    ...
    },
    {
      ...
      description:
        "Developed a cloud service for a Bluetooth virtual car key solution.",
    ...
    },
    {
      ...
      description:
        "Developed a Software-Defined Network and created tools for managing Cisco network devices.",
    ...
    },
    {
      ...
      description:
        "Lycie is the first mobile application for accident prevention, analyzing abnormal driver and road user behavior.",
      skills: [
        "Startup",
        "Entrepreneurship",
        "Business plan",
    ...
    },
    {
      ...
      description:
        "Apprentice in the sonar software department: developed software and automated unit, acceptance, and UI tests.",
  ...
  processSteps: [
    {
      ...
      title: "Discovery",
      description:
        "Analysis of your needs and objectives to define the scope of the project.",
    },
    {
      step: 2,
      title: "Proposal",
      description:
        "Development of a custom solution with detailed planning and budget.",
    },
    {
      step: 3,
      title: "Implementation",
      description:
        "Iterative development with regular check-ins to ensure your satisfaction.",
    },
  ],
  services: [
    {
      ...
      shortDescription:
        "Intelligent automation solutions using the latest LLM technologies.",
      features: [
    ...
    },
    {
      ...
      shortDescription:
        "Data flow architecture and optimization for efficient data utilization.",
      features: [
    ...
    },
    {
      ...
      shortDescription:
        "Modern web applications and robust APIs tailored to your needs.",
      features: [
  ...
  faq: [
    {
      ...
      answer:
        "After an initial discussion to understand your needs, I'll propose a tailored solution with a detailed quote. Once approved, we'll establish a timeline together, and I'll keep you regularly updated on progress with frequent demonstrations.",
    },
    {
      question: "What are your pricing options?",
      answer:
        "I offer several formats depending on your needs: daily rate, project-based package, or maintenance contract. Since each project is unique, pricing is customized after analyzing your specific requirements.",
    },
    {
      question: "How long does it take to complete a project?",
      answer:
        "Duration depends on your project's complexity. A simple API development might take a few weeks, while a complete application with AI could require several months. A precise estimate will be provided after our initial consultation.",
    },
    {
      question: "Do you offer support after project delivery?",
      answer:
        "Absolutely! I offer maintenance and evolution contracts to ensure the longevity of your solution. You also benefit from a warranty period after production deployment.",
    },
    {
      question: "Do you work on international projects?",
      answer:
        "Yes, I regularly collaborate with international clients. Thanks to modern collaborative tools and clear communication, distance is not an obstacle to your project's success.",
    },
  ],
};
